...
function download_files(){
    cd $cur_dir
    if is_64bit; then
        if ! wget -c https://github.com/iMeiji/shadowsocks_install/releases/download/0.1/shadowsocks-server-linux64-1.1.4.gz;then
        ...
        if ! wget -c https://github.com/iMeiji/shadowsocks_install/releases/download/0.1/shadowsocks-server-linux32-1.1.4.gz;then
